        ...
        <div className="p-6 rounded-3xl bg-[#0e061d]/85 backdrop-blur-xl border border-white/10 space-y-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 p-4 rounded-2xl bg-[#15082a]/70 border border-white/10">
            <div>
                ...
                <div className="flex items-center gap-2 mt-2 flex-wrap">
                  {currentUser.phoneVerified ? (
                    ...
                    <div className="inline-flex items-center gap-2">
                      <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-amber-300 bg-amber-500/15 border border-amber-500/30 px-2.5 py-0.5 rounded-full">
                        <Smartphone className="w-3.5 h-3.5 text-amber-400" />
                        Mobile Unverified
                      </span>
                      <button
                        type="button"
                        id="profile-verify-sms-trigger-btn"
                        onClick={() => openPhoneVerificationModal()}
                        className="px-2.5 py-0.5 rounded-full gradient-fiffy text-white font-bold text-[11px] shadow-sm hover:brightness-110 active:scale-95 transition-all cursor-pointer"
                      >
                        Enter SMS Code
                      </button>
                    </div>
              ...
              <div className="text-[11px] text-pink-300/90 flex items-center gap-1 mt-1.5">
